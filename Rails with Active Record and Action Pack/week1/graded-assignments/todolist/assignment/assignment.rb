...
class Assignment
  ...
  def update_password(id, password_digest)
      ...
      pass_update = User.find_by(id: id)
      pass_update.password_digest = password_digest
      pass_update.save
  end
  ...
  def update_listname(id, name)
      ...
      # (no return is required)
      list_update = TodoList.find_by(id: id)
      list_update.list_name = name
      list_update.save
  end 
  ...
  def delete_user(id)
      ...
      # (no return is required)
      user_to_delete = User.find_by(id: id)
  ...
  def delete_todolist(id)
      ...
      # (no return is required)
      todolist_to_delete = TodoList.find_by(id: id)
      todolist_to_delete.destroy
  end
end
